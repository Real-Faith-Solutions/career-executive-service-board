...
class ErisGeneralReportController extends Controller
{
    ...
    public function generatePdfReport($recordsPerPartition, $partitionNumber, $skippedData, $filename,$sortBy, $sortOrder)
    {
        $conferred = "conferred";
    ...
    public function generateDownloadLinks($sortBy, $sortOrder)
    {
        ...
        $eradTblMain->chunk($recordsPerPartition, function ($partition) use (&$downloadLinks, $recordsPerPartition, &$partitionNumber, &$skippedData, $sortBy, $sortOrder) {
