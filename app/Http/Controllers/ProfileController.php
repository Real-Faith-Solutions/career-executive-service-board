...
class ProfileController extends Controller
{
    ...
    public function viewProfile($cesno)
    {
        ...
        $cesStatusCode = PersonalData::find($cesno)->cesStatusCode;
        $cesStatusAccCode = PersonalData::find($cesno)->cesStatusAccCode;
        $cesStatusTypeCode = PersonalData::find($cesno)->cesStatusTypeCode;
        $appointingAuthority = PersonalData::find($cesno)->appointingAuthority;
        ...
        'cesStatusCode', 'cesStatusAccCode', 'cesStatusTypeCode', 'appointingAuthority'));
    ...
    public function view201ProfilePage($cesno, $numberOfResult = 50)
    {
        ...
        if (RolesController::validateUserCesWebAppGeneralPageAccess('201 Profiling') == 'true') {
            ...
            if (ProfileController::latestCesNo() == 0) {
                ...
                return view('admin.add_view_edit_201_profile', compact(
                    'searched',
                    'personalData',
                    ...
                    'CaseRecords',
                    'HealthRecords',
                    'HistoricalRecordOfMedicalCondition',
                    'PdfLinks',
                    'CityMunicipality',
                    'Degree',
                    'CourseMajor',
    ...
    public function getCesnoID($request)
    {
        ...
        if (RolesController::validateUserCesWebAppGeneralPageAccess('201 Profiling') == 'true') {
            ...
            return compact(
                ...
                'EducationalAttainmentViewOnly',
                'ExaminationsTakenAdd',
                'ExaminationsTakenEdit',
                'ExaminationsTakenDelete',
                'ExaminationsTakenViewOnly',
                'LanguagesDialectsAdd',
                'LanguagesDialectsEdit',
                'LanguagesDialectsDelete',
                'LanguagesDialectsViewOnly',
                'EligibilityAndRankTrackerAdd',
                'EligibilityAndRankTrackerEdit',
                'EligibilityAndRankTrackerDelete',
                'EligibilityAndRankTrackerViewOnly',
                'RecordOfCespesRatingsAdd',
                'RecordOfCespesRatingsEdit',
                'RecordOfCespesRatingsDelete',
                'RecordOfCespesRatingsViewOnly',
                'WorkExperienceAdd',
                'WorkExperienceEdit',
                'WorkExperienceDelete',
                'WorkExperienceViewOnly',
                'FieldExpertiseAdd',
                'FieldExpertiseEdit',
                'FieldExpertiseDelete',
                'FieldExpertiseViewOnly',
                'CesTrainingsAdd',
                'CesTrainingsEdit',
                'CesTrainingsDelete',
                'CesTrainingsViewOnly',
                'OtherManagementTrainingsAdd',
                'OtherManagementTrainingsEdit',
                'OtherManagementTrainingsDelete',
                'OtherManagementTrainingsViewOnly',
                'ResearchAndStudiesAdd',
                'ResearchAndStudiesEdit',
                'ResearchAndStudiesDelete',
                'ResearchAndStudiesViewOnly',
                'ScholarshipsAdd',
                'ScholarshipsEdit',
                'ScholarshipsDelete',
                'ScholarshipsViewOnly',
                'AffiliationsAdd',
                'AffiliationsEdit',
                'AffiliationsDelete',
                'AffiliationsViewOnly',
                'AwardAndCitationsAdd',
                'AwardAndCitationsEdit',
                'AwardAndCitationsDelete',
                'AwardAndCitationsViewOnly',
                'CaseRecordsAdd',
                'CaseRecordsEdit',
                'CaseRecordsDelete',
                'CaseRecordsViewOnly',
    ...
    public function getCesStatus($id)
    {
        ...
        if (RolesController::validateUserExecutive201RoleAccess('Eligibility and Rank Tracker', 'Category Only') == 'true') {
            ...
            $cesstatus = ProfileTblCesStatus::where('ctrlno', '=', $id)->get();
    ...
    public function deleteCesStatus($id)
    {
        ...
        if (RolesController::validateUserExecutive201RoleAccess('Eligibility and Rank Tracker', 'Delete') == 'true') {
            ...
            $cesstatus = ProfileTblCesStatus::where('ctrlno', '=', $id)->delete();
