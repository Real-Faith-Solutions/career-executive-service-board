...
class CesoAndNonCesPositionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.plantilla.reports.ceso-eligibles-nonces-position.index', compact(
    ...
    public function generatePDF($deptid)
    {
        ...
        $pdf = Pdf::loadView(
            'admin.plantilla.reports.ceso-eligibles-nonces-position.pdf',
            compact(
                'motherDepartmentAgency',
                'currentDate',
                'planAppointee',
