...
class AttachedNonCesoAndCesPositionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.plantilla.reports.attached-nonceso-noneligibles-ces-position.index', compact(
    ...
    public function generatePDF($deptid)
    {
        ...
        $pdf = Pdf::loadView(
            'admin.plantilla.reports.attached-nonceso-noneligibles-ces-position.pdf',
            compact(
                'departments',
                'office',
                'motherDepartmentAgency',
