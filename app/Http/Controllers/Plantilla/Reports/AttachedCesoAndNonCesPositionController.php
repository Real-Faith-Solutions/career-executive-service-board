...
class AttachedCesoAndNonCesPositionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.plantilla.reports.attached-ceso-eligibles-nonces-position.index', compact(
    ...
    public function generatePDF($deptid)
    {
        ...
        $pdf = Pdf::loadView(
            'admin.plantilla.reports.attached-ceso-eligibles-nonces-position.pdf',
            compact(
                'departments',
                'office',
                'motherDepartmentAgency',
