...
$.extend( DataTable.ext.classes, {
	...
	sFilterInput:  "bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5",
	...
	tailwindcss: {
		paging: {
			...
			first: 'rounded-l-lg',
			last: 'rounded-r-lg',
			enabled: 'text-gray-800 hover:opacity-75 hover:border-gray-300 hover:shadow-sm focus:ring focus:ring-gray-300 focus:ring-opacity-25',
