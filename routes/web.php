...
Route::middleware('auth', 'verify.email.and.device')->group(function () {
    ...
    Route::prefix('competency-report')->group(function () {
        ...
        Route::prefix('training-venue-manager')->group(function () {
            ...
            Route::get('generate-pdf/{totalParts}/{recordsPerPartition}/{partitionNumber}/{skippedData}/{filename}/{search}', [TrainingVenueManagerReportController::class, 'generatePdf'])->name('competency-management-sub-modules-report.trainingVenueManagerReportGeneratePdf')->middleware('checkPermission:competency_training_venue_manager_reports');
        });
        ...
        Route::prefix('resource-speaker-manager')->group(function () {
            ...
            Route::get('report-generate-pdf/{totalParts}/{recordsPerPartition}/{partitionNumber}/{skippedData}/{filename}/{expertise}/{startDate}/{endDate}', [ResourceSpeakerManagerReportController::class, 'generateReport'])->name('competency-management-sub-modules-report.resourceSpeakerGenerateReport')->middleware('checkPermission:competency_resource_speaker_manager_reports');
        });
    });
    ...
    Route::prefix('eris-report')->group(function () {
        Route::prefix('board-interview-report')->group(function () {
            ...
            Route::get('generate-pdf/{totalParts}/{recordsPerPartition}/{partitionNumber}/{skippedData}/{filename}/{sortBy}/{sortOrder}', [BoardInterviewReportController::class, 'generateReportPdf'])->name('eris-interview-report.generateReportPdf')->middleware('checkPermission:eligibility_board_interview_reports');
        });
        ...
        Route::prefix('panel-board-interview-report')->group(function () {
            ...
            Route::get('generate-pdf/{totalParts}/{recordsPerPartition}/{partitionNumber}/{skippedData}/{filename}/{sortBy}/{sortOrder}', [PanelBoardInterviewReportController::class, 'generateReportPdf'])->name('panel-board-interview-report.generateReportPdf')->middleware('checkPermission:eligibility_board_interview_reports');
        });
        ...
        Route::prefix('rapid-validation-report')->group(function () {
            ...
            Route::get('generate-pdf/{totalParts}/{recordsPerPartition}/{partitionNumber}/{skippedData}/{filename}/{sortBy}/{sortOrder}/{startDate}/{endDate}', [RapidValidationReportController::class, 'generatePdfReport'])->name('rapid-validation-report.generatePdfReport')->middleware('checkPermission:eligibility_validation_reports');
        });
        ...
        Route::prefix('assessment-center-report')->group(function () {
            ...
            Route::get('generate-pdf/{totalParts}/{recordsPerPartition}/{partitionNumber}/{skippedData}/{filename}/{sortBy}/{sortOrder}', [AssessmentCenterReportController::class, 'generateReportPdf'])->name('assessment-center-report.generateReportPdf')->middleware('checkPermission:eligibility_assessment_center_reports');
        });
        ...
        Route::prefix('written-exam-report')->group(function () {
            ...
            Route::get('generate-report/{totalParts}/{recordsPerPartition}/{partitionNumber}/{skippedData}/{filename}/{sortBy}/{sortOrder}', [WrittenExamReportController::class, 'generateReportPdf'])->name('written-exam-report.generateReportPdf')->middleware('checkPermission:eligibility_ceswe_reports');
        });
    ...
    Route::prefix('201-reports')->group(function () {
        ...
        Route::prefix('general-reports')->group(function () {
            ...
            Route::get('generate-reports/
                        {totalParts}/{recordsPerPartition}/{partitionNumber}/{skippedData}/{filename}/
                        ...
                        {authority_code}/{report_title}', [Reports201Controller::class, 'generatePdf'])->name('general-reports.pdf')->middleware('checkPermission:201_general_reports');
            Route::get('download-general-reports/
                        {sortBy}/{sortOrder}/{filter_active}/{filter_inactive}/
                        {filter_retired}/{filter_deceased}/{filter_retirement}/
                        {with_pending_case}/{without_pending_case}/{cesstat_code}/
                        {authority_code}/{report_title}', [Reports201Controller::class, 'generateDownloadLinks'])->name('download-general-reports.pdf')->middleware('checkPermission:201_general_reports');
        });
        ...
        Route::prefix('birthday')->group(function () {
            ...
            Route::get('monthly/celebrant/report/pdf/{totalParts}/{recordsPerPartition}/{partitionNumber}/{skippedData}/{filename}/{sortBy}/{sortOrder}', [BirthdayCardReportController::class, 'monthlyCelebrantGeneratePdfReport'])->name('birthday.monthlyCelebrantGeneratePdfReport')->middleware('checkPermission:201_birthday_cards_reports');
        ...
        Route::prefix('reports-for-placement')->group(function () {
            ...
            Route::get('generate-report/{totalParts}/{recordsPerPartition}/{partitionNumber}/{skippedData}/{filename}/{sortBy}/{sortOrder}/{expertise}/{degree}', [PlacementReportController::class, 'generatePdfReport'])->name('reports-for-placement.generatePdfReport')->middleware('checkPermission:201_placement_reports');
        });
    });
