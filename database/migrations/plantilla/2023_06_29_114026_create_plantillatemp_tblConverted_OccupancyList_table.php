...
return new class extends Migration
{
    /**
     * Run the migrations.
     * PlantillaTempTblConvertedOccupancyList
     * this is newly created migration in order to make a counterpart table from DB of legacy system
     */
    public function up(): void
    {
        Schema::create('plantillatemp_tblConverted_OccupancyList', function (Blueprint $table) {
            $table->id('posting_dt');
    ...
    {
        Schema::dropIfExists('plantillatemp_tblConverted_OccupancyList');
    }
};
