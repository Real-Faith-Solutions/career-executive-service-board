@extends('layouts.app')
@section('title', 'Agency Location Type - Trash')
@section('content')
...
<div class="my-5 flex justify-between gap-4">
    ...
    <a class="btn btn-primary" href="{{ route('library-location-type.index') }}">Go back</a>
</div>
                ...
                <td class="px-6 py-4 text-right uppercase">
                    <div class="flex justify-end">
                        <form class="hover:bg-slate-100 rounded-full"
                            action="{{ route('library-location-type.restore', $data->agencyloc_Id) }}" method="POST"
                        ...
                        <form class="hover:bg-slate-100 rounded-full"
                            action="{{ route('library-location-type.forceDelete', $data->agencyloc_Id) }}" method="POST"
