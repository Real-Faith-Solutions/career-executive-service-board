@extends('layouts.app')
@section('title', 'Mother Department Manager - Trash')
@section('content')
                ...
                <td class="px-6 py-4 text-right uppercase">
                    <div class="flex justify-end">
                        <form class="hover:bg-slate-100 rounded-full"
                            action="{{ route('library-mother-dept.restore', $data->deptid) }}" method="POST"
                        ...
                        <form class="hover:bg-slate-100 rounded-full"
                            action="{{ route('library-mother-dept.forceDelete', $data->deptid) }}" method="POST"
