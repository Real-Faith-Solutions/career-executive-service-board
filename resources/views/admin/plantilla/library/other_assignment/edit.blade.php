@extends('layouts.app')
@section('title', 'Other Assignment - Edit')
@section('content')
...
<div class="my-5 flex justify-between gap-4">
    ...
    <a class="btn btn-primary" href="{{ route('library-other-assignment.index', $appointee_id) }}">
        Go back
    </a>
</div>
...
<div class="relative my-10 overflow-x-auto shadow-lg sm:rounded-lg">
    <div class="w-full text-left text-gray-500">
        ...
        <div class="bg-white px-6 py-3">
            <form action="{{ route('library-other-assignment.update', $datas->detailed_code) }}" method="POST">
                @csrf
                    ...
                    <fieldset class="border p-4">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div class="mb-3">
                                ...
                                <input id="office" name="office" readonly value="{{ $datas->office }}" />
                                @error('office')
                            ...
                            <div class="mb-3">
                                ...
                                <input id="house_bldg" name="house_bldg" value="{{ $datas->house_bldg }}" />
                                @error('house_bldg')
                                <span class="invalid" role="alert">
                                    <p>{{ $message }}</p>
                                </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="st_road" name="st_road" value="{{ $datas->st_road }}" />
                                @error('st_road')
                                <span class="invalid" role="alert">
                                    <p>{{ $message }}</p>
                                </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="brgy_vill" name="brgy_vill" value="{{ $datas->brgy_vill }}" />
                                @error('brgy_vill')
                                <span class="invalid" role="alert">
                                    <p>{{ $message }}</p>
                                </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="contactno" name="contactno" type="tel" value="{{ $datas->contactno }}" />
                                @error('contactno')
                                <span class="invalid" role="alert">
                                    <p>{{ $message }}</p>
                                </span>
                    ...
                    <fieldset class="border p-4">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="position" name="position" readonly value="{{ $datas->position }}" />
                                @error('name')
                                <span class="invalid" role="alert">
                                    <p>{{ $message }}</p>
                                </span>
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="to_dt" name="to_dt" required type="date" value="{{ $datas->to_dt }}" />
                                    @error('to_dt')
                                    <span class="invalid" role="alert">
                                        <p>{{ $message }}</p>
                                    </span>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="remarks" id="remarks" cols="30" rows="10">{{ $datas->remarks }}</textarea>
                            @error('remarks')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
                            </span>
