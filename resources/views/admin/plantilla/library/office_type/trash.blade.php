@extends('layouts.app')
@section('title', 'Office Type - Trash')
@section('content')
                ...
                <td class="px-6 py-4 text-right uppercase">
                    <div class="flex justify-end">
                        <form class="hover:bg-slate-100 rounded-full"
                            action="{{ route('library-office-type.restore', $data->agency_typeid) }}" method="POST"
                        ...
                        <form class="hover:bg-slate-100 rounded-full"
                            action="{{ route('library-office-type.forceDelete', $data->agency_typeid) }}" method="POST"
