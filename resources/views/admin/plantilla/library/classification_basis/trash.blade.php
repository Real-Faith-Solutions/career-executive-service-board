@extends('layouts.app')
@section('title', 'Classification Basis Title - Trash')
@section('content')
                ...
                <td class="px-6 py-4 text-right uppercase">
                    <div class="flex justify-end">
                        <form class="hover:bg-slate-100 rounded-full"
                            action="{{ route('library-class-basis.restore', $data->cbasis_code) }}" method="POST"
                        ...
                        <form class="hover:bg-slate-100 rounded-full"
                            action="{{ route('library-class-basis.forceDelete', $data->cbasis_code) }}" method="POST"
