            ...
            <form action="" method="POST" id="resource_speaker_form" onsubmit="return checkErrorsBeforeSubmit(resource_speaker_form)">
                ...
                <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="resourceEmailAdd" name="emailAdd" oninput="validateInputEmail(emailAdd)" onkeypress="validateInputEmail(emailAdd)" onblur="checkErrorMessage(emailAdd)" >
                        <p class="input_error text-red-600"></p>
                        @error('emailAdd')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
