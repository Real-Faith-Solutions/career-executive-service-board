...
<div class="relative my-10 overflow-x-auto shadow-lg sm:rounded-lg">
    <div class="w-full text-left text-gray-500">
        ...
        <div class="bg-white px-6 py-3">
            <form action="{{ route('training-venue-manager.store') }}" method="POST" id="training_venue_manager_form" onsubmit="return checkErrorsBeforeSubmit(training_venue_manager_form)">
                @csrf
