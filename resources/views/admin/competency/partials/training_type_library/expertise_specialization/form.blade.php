...
<div class="relative my-10 overflow-x-auto shadow-lg sm:rounded-lg">
    <div class="w-full text-left text-gray-500">
        ...
        <div class="bg-white px-6 py-3">
            <form action="{{ route('training-secretariat.store') }}" method="POST" id="competency_field_specialization_form" onsubmit="return checkErrorsBeforeSubmit(competency_field_specialization_form)">
                @csrf
