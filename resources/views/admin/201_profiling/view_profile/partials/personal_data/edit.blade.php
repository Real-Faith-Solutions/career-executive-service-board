...
<div class="grid-rows-7 grid lg:grid-cols-3 sm:grid-cols-1 gap-1">
    ...
    <form class="col-span-3" action="{{ route('edit-profile-201', ['cesno'=>$mainProfile->cesno]) }}"
        enctype="multipart/form-data" id="edit_personal_data" method="POST"
        onsubmit="return checkErrorsBeforeSubmit(edit_personal_data)">
            ...
            <div class="relative my-10 overflow-x-auto shadow-lg sm:rounded-lg">
                <div class="w-full text-left text-gray-500">
                    <div class="bg-blue-500 uppercase text-gray-700 text-white flex justify-between">
                        ...
                        <a href="{{ route('personal-data.show', ['cesno' => $mainProfile->cesno]) }}"
                            class="px-6 py-3 text-right">Back</a>
                    </div>
                    ...
                    <div class="border-b bg-white px-6 py-3">
                        ...
                        <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="email" name="email" type="text" value="{{ $mainProfile->email }}"
                                    oninput="validateInputEmail(email)" onkeypress="validateInputEmail(email)"
                                    onblur="checkErrorMessage(email)" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="name_extension" list="name_extension_choices" name="name_extension"
                                    value="{{ $mainProfile->name_extension }}" type="search">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="nickname" name="nickname" type="text" value="{{ $mainProfile->nickname }}"
                                    oninput="validateInput(nickname, 0, 'letters')"
                                    onkeypress="validateInput(nickname, 0, 'letters')"
                                    onblur="checkErrorMessage(nickname)">
                                <p class="input_error text-red-600"></p>
                            </div>

                            <div class="mb-3">
                                <label for="birthdate">Birthdate<sup>*</sup></label>
                                <input type="date" id="birthdateEdit" name="birthdate" onchange="computeAgeEdit()"
                                    oninput="validateDateInput(birthdate, 18)"
                                    value="{{ $mainProfile->birth_date ? \Carbon\Carbon::parse($mainProfile->birth_date)->format('Y-m-d') : now()->format('Y-m-d') }}"
                                    required>
                                <p class="input_error text-red-600"></p>
                            </div>
                            ...
                            {{-- <div class="mb-3">
                                ...
                                <input id="birth_place" name="birth_place" type="text"
                                    value="{{ $mainProfile->cities->name }}" oninput="validateInput(birth_place, 2)"
                                    onkeypress="validateInput(birth_place, 2)" onblur="checkErrorMessage(birth_place)">
                                <p class="input_error text-red-600"></p>
                            </div> --}}
                            <div class="mb-3">
                                <label for="birth_place">Birth Place<sup>*</sup></label>
                                <select id="birth_place" name="birth_place">
                                    ...
                                    <option value="{{ $data->city_code }}" {{ $data->city_code ==
                                        $mainProfile->birth_place ? 'selected' : '' }}>
                                        {{ $data->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="gender_by_choice" list="gender_by_choice_choices" name="gender_by_choice"
                                    value="{{ $mainProfile->gender_by_choice }}" required type="search">
                            ...
                            <div class="mb-3">
                                ...
                                <input list="religion_choices" id="religion" name="religion"
                                    value="{{ $mainProfile->religion }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="profile_height" name="height" type="text" value="{{ $mainProfile->height }}"
                                    oninput="validateInput(profile_height, 2, 'numbersWithSpecial')"
                                    onkeypress="validateInput(profile_height, 2, 'numbersWithSpecial')"
                            ...
                            <div class="mb-3">
                                ...
                                <input id="profile_weight" name="weight" type="text" value="{{ $mainProfile->weight }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input id="member_of_indigenous_group" list="member_of_indigenous_group_choices"
                                    name="member_of_indigenous_group" name="member_of_indigenous_group"
                                    value="{{ $mainProfile->member_of_indigenous_group }}" required type="search">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="person_with_disability" list="person_with_disability_choices"
                                    name="person_with_disability" value="{{ $mainProfile->person_with_disability }}"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control w-100 citizenShip mb-3" id="editCitizenship"
                                    name="citizenship" onchange="toggleCitizenshipEdit()" required>
                            ...
                            <div class="mb-3" id="dualCitizenshipField"
                                ...
                                <input id="dual_citizenship" list="dual_citizenship_choices" name="dual_citizenship"
                                    value="{{ $mainProfile->dual_citizenship }}" type="search">
                        ...
                        <div class="flex justify-end">
                            ...
                            <button type="button" class="btn btn-primary" id="edit_profile_save"
                                onclick="openConfirmationDialog(this, 'Confirm Changes', 'Are you sure you want to save this changes?')">
                                Save changes
                            </button>
                        </div>
