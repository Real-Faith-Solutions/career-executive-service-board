                    ...
                    <div class="border-b bg-white px-6 py-3">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="relative w-3/4">
                                <input id="currentPassword" name="currentPassword" type="password" required class="w-full px-3 py-2 border rounded pr-10">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="relative w-3/4">
                                <input id="password" name="password" type="password" oninput="validateInputPassword(password), checkPasswordMatch()" onkeypress="validateInputPassword(password), checkPasswordMatch()" onblur="checkErrorMessage(password)" required class="w-full px-3 py-2 border rounded pr-10">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="relative w-3/4">
                                <input id="confirmPassword" name="confirmPassword" type="password" oninput="checkPasswordMatch()" onkeypress="checkPasswordMatch()" onblur="checkErrorMessage(confirmPassword)" required class="w-full px-3 py-2 border rounded pr-10">
