            ...
            <form action="{{ route('affiliation.store', ['cesno'=>$cesno]) }}" method="POST" id="affiliation_form" onsubmit="return checkErrorsBeforeSubmit(affiliation_form)">
                ...
                <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="affiliation_date_from" name="date_from" oninput="validateDateInput(affiliation_date_from), validateDateFromTo(affiliation_date_from, affiliation_date_to)">
                        <p class="input_error text-red-600"></p>
                        @error('date_from')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="affiliation_date_to" name="date_to" oninput="validateDateInput(affiliation_date_to), validateDateFromTo(affiliation_date_from, affiliation_date_to)">
                        <p class="input_error text-red-600"></p>
                        @error('date_to')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
