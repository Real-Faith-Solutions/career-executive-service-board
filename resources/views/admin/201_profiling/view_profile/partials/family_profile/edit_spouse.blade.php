            ...
            <form action="{{ route('family-profile.updateSpouseRecord', ['ctrlno'=>$spouseRecord->ctrlno]) }}" method="POST"  id="update_spouse_form" onsubmit="return checkErrorsBeforeSubmit(update_spouse_form)">
                ...
                <div>
                    <div class="flex justify-end">
                        <button type="button" class="btn btn-primary" id="updateSpouseButton" onclick="openConfirmationDialog(this, 'Confirm Changes', 'Are you sure you want to update this info?')">
                            Update Changes
                        </button>
                    </div>
                </div>
