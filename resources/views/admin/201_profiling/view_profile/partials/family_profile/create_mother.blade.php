...
<form action="{{ route('family-profile-mother.store', ['cesno' => $mainProfile->cesno]) }}" method="POST" id="family_profile_mother" onsubmit="return checkErrorsBeforeSubmit(family_profile_mother)">
    ...
    <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="mother_middle_name" name="mother_middle_name" oninput="validateInput(mother_middle_name, 0, 'letters')" onkeypress="validateInput(mother_middle_name, 0, 'letters')" onblur="checkErrorMessage(mother_middle_name)">
            <p class="input_error text-red-600"></p>
