...
<form action="{{ route('family-profile-father.store', ['cesno' => $cesno]) }}" method="POST" id="family_profile_father" onsubmit="return checkErrorsBeforeSubmit(family_profile_father)">
    ...
    <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-2">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="father_first_name" name="father_first_name" oninput="validateInput(father_first_name, 2, 'letters')" onkeypress="validateInput(father_first_name, 2, 'letters')" onblur="checkErrorMessage(father_first_name)" required>
            <p class="input_error text-red-600"></p>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="father_middle_name" name="father_middle_name" oninput="validateInput(father_middle_name, 2, 'letters')" onkeypress="validateInput(father_middle_name, 2, 'letters')" onblur="checkErrorMessage(father_middle_name)" required>
            <p class="input_error text-red-600"></p>
