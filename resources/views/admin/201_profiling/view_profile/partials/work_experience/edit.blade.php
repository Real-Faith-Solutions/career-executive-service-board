            ...
            <form action="{{ route('work-experience.update', ['ctrlno'=>$workExperience->ctrlno, 'cesno'=>$cesno]) }}" method="POST" id="update_work_experience_form" onsubmit="return checkErrorsBeforeSubmit(update_work_experience_form)">
                ...
                <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <div class="mb-3">
                        ...
                        <input type="date" id="inclusive_date_from" name="inclusive_date_from" value="{{ $workExperience->from_dt }}" oninput="validateDateInput(inclusive_date_from), validateDateFromTo(inclusive_date_from, inclusive_date_to)" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="inclusive_date_to" name="inclusive_date_to" value="{{ $workExperience->to_dt }}" oninput="validateDateInput(inclusive_date_to), validateDateFromTo(inclusive_date_from, inclusive_date_to)" required>
                        <p class="input_error text-red-600"></p>
