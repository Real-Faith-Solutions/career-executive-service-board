<form action="{{ route('add-address-temporary-201', ['cesno'=>$cesno]) }}" enctype="multipart/form-data" id="address_temporary" onsubmit="return checkErrorsBeforeSubmit(address_temporary)" method="POST">
    ...
    <div class="flex justify-end">
        <button type="button" class="btn btn-primary" id="updateTemporaryAddressButton" onclick="openConfirmationDialog(this, 'Confirm Address', 'Are you sure you want to submit/update this info?')">Save Changes</button>
    </div>
</form>