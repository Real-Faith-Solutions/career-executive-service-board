            ...
            @endif
                ...
                <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <div class="mb-3">
                        ...
                        <input id="official_mobile_number1" name="official_mobile_number1" type="text" value="{{ old('official_mobile_number1') ?? ($contacts->official_mobile_number1 ?? '') }}" oninput="validateInput(official_mobile_number1, 11, 'numbers')" onkeypress="validateInput(official_mobile_number1, 11, 'numbers')" onblur="checkErrorMessage(official_mobile_number1)" required>
                        <p class="input_error text-red-600"></p>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="official_mobile_number2" name="official_mobile_number2" type="text" value="{{ old('official_mobile_number2') ?? ($contacts->official_mobile_number2 ?? '') }}" oninput="validateInput(official_mobile_number2, 0, 'numbers')" onkeypress="validateInput(official_mobile_number2, 0, 'numbers')" onblur="checkErrorMessage(official_mobile_number2)">
                        <p class="input_error text-red-600"></p>
                ...
                <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <div class="mb-3">
                        ...
                        <input id="personal_mobile_number1" name="personal_mobile_number1" type="text" value="{{ old('personal_mobile_number1') ?? ($contacts->personal_mobile_number1 ?? '') }}" oninput="validateInput(personal_mobile_number1, 11, 'numbers')" onkeypress="validateInput(personal_mobile_number1, 11, 'numbers')" onblur="checkErrorMessage(personal_mobile_number1)" required>
                        <p class="input_error text-red-600"></p>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="personal_mobile_number2" name="personal_mobile_number2" type="text" value="{{ old('personal_mobile_number2') ?? ($contacts->personal_mobile_number2 ?? '') }}" oninput="validateInput(personal_mobile_number2, 0, 'numbers')" onkeypress="validateInput(personal_mobile_number2, 0, 'numbers')" onblur="checkErrorMessage(personal_mobile_number2)">
                        <p class="input_error text-red-600"></p>
