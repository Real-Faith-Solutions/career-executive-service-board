            ...
            <form action="{{ route('scholarship.update', ['ctrlno'=>$scholarship->ctrlno, 'cesno'=>$cesno]) }}" method="POST" id="update_scholarship_taken_form" onsubmit="return checkErrorsBeforeSubmit(update_scholarship_taken_form)">
                ...
                <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <div class="mb-3">
                        ...
                        <input id="inclusive_date_from" name="inclusive_date_from" value="{{ $scholarship->from_dt }}" type="text">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="inclusive_date_to" name="inclusive_date_to" value="{{ $scholarship->to_dt }}" type="text">
