            ...
            <form action="{{ route('case-record.update', ['ctrlno'=>$caseRecord->ctrlno, 'cesno'=>$cesno]) }}" method="POST" id="case_records_edit" onsubmit="return checkErrorsBeforeSubmit(case_records_edit)">
                ...
                <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="date_filed_edit" name="date_filed" value="{{ $caseRecord->filed_dt }}" oninput="validateDateInput(date_filed_edit), validateDateFromTo(date_filed_edit, date_finality)" required>
                        <p class="input_error text-red-600"></p>
                        @error('date_filed')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
                ...
                <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="date_finality_edit" name="date_finality" value="{{ \Carbon\Carbon::parse($caseRecord->finality)->format('m/d/Y') }}" oninput="validateDateInput(date_finality_edit), validateDateFromTo(date_filed_edit, date_finality_edit)" required>
                        <p class="input_error text-red-600"></p>
                        @error('date_finality')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
