                ...
                <tr class="border-b bg-white">
                    ...
                    <td class="px-6 py-4 text-right uppercase">
                        <div class="flex">
                            ...
                            <form action="{{ route('research-studies.destroy', ['ctrlno'=>$researchAndStudy->ctrlno]) }}" method="POST" id="delete_scholarships_form{{$researchAndStudy->ctrlno}}">
                                @csrf
                                @method('DELETE')
                                <button type="button" id="deleteResearchAndStudyButton{{$researchAndStudy->ctrlno}}" onclick="openConfirmationDialog(this, 'Confirm Deletion', 'Are you sure you want to delete this info?')">
