                ...
                <div class="relative my-2 overflow-x-auto shadow-lg sm:rounded-lg">
                    <div class="w-full text-gray-500">
                        ...
                        <div class="border-b bg-white px-6 py-3">
                            ...
                            <div class="flex items-center mb-4">
                                <input id="work_experience_add" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'work_experience_add') ? 'checked' : '' }} value="work_experience_add" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="work_experience_add" class="ml-2 mt-2 text-sm font-medium text-gray-900">Add</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="work_experience_edit" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'work_experience_edit') ? 'checked' : '' }} value="work_experience_edit" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="work_experience_edit" class="ml-2 mt-2 text-sm font-medium text-gray-900">Edit</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="work_experience_delete" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'work_experience_delete') ? 'checked' : '' }} value="work_experience_delete" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="work_experience_delete" class="ml-2 mt-2 text-sm font-medium text-gray-900">Delete</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="work_experience_view" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'work_experience_view') ? 'checked' : '' }} value="work_experience_view" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                ...
                <div class="relative my-2 overflow-x-auto shadow-lg sm:rounded-lg">
                    <div class="w-full text-gray-500">
                        ...
                        <div class="border-b bg-white px-6 py-3">
                            ...
                            <div class="flex items-center mb-4">
                                <input id="ces_trainings_add" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'ces_trainings_add') ? 'checked' : '' }} value="ces_trainings_add" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="ces_trainings_add" class="ml-2 mt-2 text-sm font-medium text-gray-900">Add</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="ces_trainings_edit" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'ces_trainings_edit') ? 'checked' : '' }} value="ces_trainings_edit" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="ces_trainings_edit" class="ml-2 mt-2 text-sm font-medium text-gray-900">Edit</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="ces_trainings_delete" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'ces_trainings_delete') ? 'checked' : '' }} value="ces_trainings_delete" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="ces_trainings_delete" class="ml-2 mt-2 text-sm font-medium text-gray-900">Delete</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="ces_trainings_view" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'ces_trainings_view') ? 'checked' : '' }} value="ces_trainings_view" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                ...
                <div class="relative my-2 overflow-x-auto shadow-lg sm:rounded-lg">
                    <div class="w-full text-gray-500">
                        ...
                        <div class="border-b bg-white px-6 py-3">
                            ...
                            <div class="flex items-center mb-4">
                                <input id="eligibility_rank_tracker_add" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'eligibility_rank_tracker_add') ? 'checked' : '' }} value="eligibility_rank_tracker_add" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="eligibility_rank_tracker_add" class="ml-2 mt-2 text-sm font-medium text-gray-900">Add</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="eligibility_rank_tracker_edit" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'eligibility_rank_tracker_edit') ? 'checked' : '' }} value="eligibility_rank_tracker_edit" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="eligibility_rank_tracker_edit" class="ml-2 mt-2 text-sm font-medium text-gray-900">Edit</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="eligibility_rank_tracker_delete" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'eligibility_rank_tracker_delete') ? 'checked' : '' }} value="eligibility_rank_tracker_delete" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="eligibility_rank_tracker_delete" class="ml-2 mt-2 text-sm font-medium text-gray-900">Delete</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="eligibility_rank_tracker_view" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'eligibility_rank_tracker_view') ? 'checked' : '' }} value="eligibility_rank_tracker_view" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                ...
                <div class="relative my-2 overflow-x-auto shadow-lg sm:rounded-lg">
                    <div class="w-full text-gray-500">
                        ...
                        <div class="border-b bg-white px-6 py-3">
                            ...
                            <div class="flex items-center mb-4">
                                <input id="cespes_ratings_add" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'cespes_ratings_add') ? 'checked' : '' }} value="cespes_ratings_add" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="cespes_ratings_add" class="ml-2 mt-2 text-sm font-medium text-gray-900">Add</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="cespes_ratings_edit" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'cespes_ratings_edit') ? 'checked' : '' }} value="cespes_ratings_edit" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="cespes_ratings_edit" class="ml-2 mt-2 text-sm font-medium text-gray-900">Edit</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="cespes_ratings_delete" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'cespes_ratings_delete') ? 'checked' : '' }} value="cespes_ratings_delete" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="cespes_ratings_delete" class="ml-2 mt-2 text-sm font-medium text-gray-900">Delete</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="cespes_ratings_view" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'cespes_ratings_view') ? 'checked' : '' }} value="cespes_ratings_view" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                ...
                <div class="relative my-2 overflow-x-auto shadow-lg sm:rounded-lg">
                    <div class="w-full text-gray-500">
                        ...
                        <div class="border-b bg-white px-6 py-3">
                            ...
                            <div class="flex items-center mb-4">
                                <input id="pdf_files_add" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'pdf_files_add') ? 'checked' : '' }} value="pdf_files_add" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="pdf_files_add" class="ml-2 mt-2 text-sm font-medium text-gray-900">Add</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="pdf_files_edit" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'pdf_files_edit') ? 'checked' : '' }} value="pdf_files_edit" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="pdf_files_edit" class="ml-2 mt-2 text-sm font-medium text-gray-900">Edit</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="pdf_files_delete" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'pdf_files_delete') ? 'checked' : '' }} value="pdf_files_delete" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
                                <label for="pdf_files_delete" class="ml-2 mt-2 text-sm font-medium text-gray-900">Delete</label>
                            </div>
    
                            <div class="flex items-center mb-4">
                                <input id="pdf_files_view" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'pdf_files_view') ? 'checked' : '' }} value="pdf_files_view" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
