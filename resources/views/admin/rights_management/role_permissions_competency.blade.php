                ...
                <div class="relative my-2 overflow-x-auto shadow-lg sm:rounded-lg">
                    <div class="w-full text-gray-500">
                        ...
                        <div class="border-b bg-white px-6 py-3">
                            ...
                            <div class="flex items-center mb-4">
                                <input id="competency_management_sub_modules_report_add" type="checkbox" name="permissions[]" {{ $permissions->contains('permission_name', 'competency_management_sub_modules_report_add') ? 'checked' : '' }} value="competency_management_sub_modules_report_add" class="w-4 h-4 text-blue-600 accent-green-600 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
