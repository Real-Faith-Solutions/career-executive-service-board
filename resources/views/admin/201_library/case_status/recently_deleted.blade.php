@extends('layouts.app')
@section('title', 'Recently Deleted - Case Status - 201 Library')
@section('content')
...
<div class="relative overflow-x-auto shadow-lg sm:rounded-lg">
    <table class="w-full text-left text-sm text-gray-500">
        ...
        <tbody>
            @foreach ($profileLibTblCaseStatusTrashRecord as $profileLibTblCaseStatusTrashRecords)
                <tr class="border-b bg-white">
                    <td class="whitespace-nowrap px-6 py-4 font-medium text-gray-900" scope="row">
                        {{ $profileLibTblCaseStatusTrashRecords->TITLE }}
                    </td>
                    <td class="px-6 py-3">
                        {{ $profileLibTblCaseStatusTrashRecords->deleted_at }}
                    </td>
...
<div class="m-5">
    {{ $profileLibTblCaseStatusTrashRecord->links() }}
</div>
