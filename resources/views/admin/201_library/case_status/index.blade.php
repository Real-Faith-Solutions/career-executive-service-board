...
<div class="my-5 flex justify-end gap-4">
    ...
    <a class="btn btn-primary" href="{{ route('case-nature-library.create') }}">Add New Case Status</a>
</div>
                ...
                <tr class="border-b bg-white">
                    ...
                    <td class="px-6 py-4 text-right uppercase">
                        <div class="flex justify-end">
                            <form action="{{ route('case-nature-library.edit', ['code'=>$profileLibTblCaseStatuses->STATUS_CODE]) }}" method="GET">
                                @csrf
