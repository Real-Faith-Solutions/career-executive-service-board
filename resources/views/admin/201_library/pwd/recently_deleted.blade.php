...
<div class="my-5 flex justify-end gap-4">
    <a class="btn btn-primary" href="{{ route('pwd.index') }}">Go back</a>
</div>
                ...
                <tr class="border-b bg-white">
                    ...
                    <td class="px-6 py-4 text-right uppercase">
                        <div class="flex justify-end">
                            <form class="hover:bg-slate-100 rounded-full" action="{{ route('pwd.restore', $data->ctrlno) }}" method="POST">
                                @csrf
                            ...
                            <form class="hover:bg-slate-100 rounded-full" action="{{ route('pwd.forceDelete', $data->ctrlno) }}" method="POST">
                                @csrf
