...
<div class="relative my-10 overflow-x-auto shadow-lg sm:rounded-lg">
    <div class="w-full text-left text-gray-500">
        <div class="bg-blue-500 uppercase text-gray-700 text-white">
            <h1 class="px-6 py-3">
                Panel Board Interview Update Form
            </h1>
        </div>
            ...
            <form action="" method="POST" id="update_panel_board_interview_form" onsubmit="return checkErrorsBeforeSubmit(update_panel_board_interview_form)">
                ...
                <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="intrviewer" value="{{ $panelBoardInterview->intrviewer }}">
                        @error('intrviewer')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
                            </span>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="recom" id="recom" cols="10" rows="3" >{{ $panelBoardInterview->recom }}</textarea>
                </div>

                <div class="flex justify-end">
                    <button type="button" class="btn btn-primary" id="updatePanelBoardInterviewButton" onclick="openConfirmationDialog(this, 'Confirm Changes', 'Are you sure you want to update this info?')">
                        Update Changes
                    </button>
                </div>
            </form>
