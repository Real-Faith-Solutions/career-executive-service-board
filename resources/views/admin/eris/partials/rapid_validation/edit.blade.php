            ...
            <form action="{{ route('eris-rapid-validation.store', ['acno'=>$acno]) }}" method="POST" id="rapid_validation_form" onsubmit="return checkErrorsBeforeSubmit(rapid_validation_form)">
                ...
                <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="validator" value="{{ $rapidValidation->validator }}">
                        @error('validator')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
                            </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="recom" value="{{ $rapidValidation->recom }}">
                        @error('recom')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
                            </span>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="remarks" id="remarks" cols="10" rows="3" >{{ $rapidValidation->remarks }}</textarea>
                </div>
