            ...
            <form action="{{ route('eris-written-exam.update', ['acno'=>$acno, 'ctrlno'=>$ctrlno]) }}" method="POST" id="update_written_exam_form" onsubmit="return checkErrorsBeforeSubmit(update_written_exam_form)">
                ...
                <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="we_location" value="{{ $writtenExamPRofileData->we_location }}">
                        @error('we_location')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
                            </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="we_rating" name="we_rating" oninput="validateInput(we_rating, 2, 'numbersWithSpecial')" onkeypress="validateInput(we_rating, 2, 'numbersWithSpecial')" onblur="checkErrorMessage(we_rating)" value="{{ $writtenExamPRofileData->we_rating }}" required>
                        <p class="input_error text-red-600"></p>
                        @error('we_rating')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="we_remarks" id="we_remarks" cols="10" rows="3" >{{ $writtenExamPRofileData->we_remarks }}</textarea>
                </div>
