            ...
            <form action="{{ route('eris-written-exam.store', ['acno'=>$acno]) }}" method="POST" id="written_exam_form" onsubmit="return checkErrorsBeforeSubmit(written_exam_form)">
                ...
                <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="numtakes" name="numtakes" oninput="validateInput(numtakes, 1, 'numbers')" onkeypress="validateInput(numtakes, 1, 'numbers')" onblur="checkErrorMessage(numtakes)" required>
                        <p class="input_error text-red-600"></p>
                        @error('numtakes')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
