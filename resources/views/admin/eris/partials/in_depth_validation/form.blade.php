...
<div class="relative my-10 overflow-x-auto shadow-lg sm:rounded-lg">
    <div class="w-full text-left text-gray-500">
        <div class="bg-blue-500 uppercase text-gray-700 text-white">
            <h1 class="px-6 py-3">
                In Depth Validation Form
            </h1>
        </div>
        
        <div class="bg-white px-6 py-3">
            <form action="{{ route('eris-in-depth-validation.store', ['acno'=>$acno]) }}" method="POST" id="in_depth_validation_form" onsubmit="return checkErrorsBeforeSubmit(in_depth_validation_form)">
                @csrf
