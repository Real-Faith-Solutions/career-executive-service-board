            ...
            <form action="{{ route('eris-board-interview.update', ['acno'=>$acno, 'ctrlno'=>$ctrlno]) }}" method="POST" id="update_board_interview_form" onsubmit="return checkErrorsBeforeSubmit(update_board_interview_form)">
                ...
                <div class="sm:gid-cols-1 mb-3 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="dteassign" name="dteassign" oninput="validateDateInput(dteassign)" value="{{ $boardInterview->dteassign }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="dtesubmit" name="dtesubmit" oninput="validateDateInput(dtesubmit)" value="{{ $boardInterview->dtesubmit }}">
                        <p class="input_error text-red-600"></p>
                        @error('dtesubmit')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="dteiview" name="dteiview" oninput="validateDateInput(dteiview)" value="{{ $boardInterview->dteiview }}">
                        <p class="input_error text-red-600"></p>
                        @error('dteiview')
                            <span class="invalid" role="alert">
                                <p>{{ $message }}</p>
