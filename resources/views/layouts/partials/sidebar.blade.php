        ...
        <ul class="space-y-2 font-medium">
            ...
            @if($userRole !== "user")
                ...
                <li>
                    <button type="button"
                        class="group flex w-full items-center rounded-lg p-2 text-gray-900 transition duration-75 hover:bg-gray-100"
                        aria-controls="dropdown-201-reports" data-collapse-toggle="dropdown-201-reports" aria-expanded="{{ request()->is('201-reports*') ? 'true' : 'false' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="h-6 w-6 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900">
                            <path
                    ...
                    <ul id="dropdown-201-reports" class="{{ request()->is('201-reports*') ? '' : 'hidden' }} space-y-2 py-2">
                        <li>
                ...
                <li>
                    <button type="button"
                        class="group flex w-full items-center rounded-lg p-2 text-gray-900 transition duration-75 hover:bg-gray-100"
                        aria-controls="eris-dropdown-system-utility" data-collapse-toggle="eris-dropdown-system-utility" aria-expanded="{{ request()->is('eris-library*') ? 'true' : 'false' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="h-6 w-6 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900">
                            <path
                                d="M11.25 4.533A9.707 9.707 0 006 3a9.735 9.735 0 00-3.25.555.75.75 0 00-.5.707v14.25a.75.75 0 001 .707A8.237 8.237 0 016 18.75c1.995 0 3.823.707 5.25 1.886V4.533zM12.75 20.636A8.214 8.214 0 0118 18.75c.966 0 1.89.166 2.75.47a.75.75 0 001-.708V4.262a.75.75 0 00-.5-.707A9.735 9.735 0 0018 3a9.707 9.707 0 00-5.25 1.533v16.103z" />
                ...
                <li>
                    <button type="button"
                        class="group flex w-full items-center rounded-lg p-2 text-gray-900 transition duration-75 hover:bg-gray-100"
                        aria-controls="eris-dropdown-reports" data-collapse-toggle="eris-dropdown-reports" aria-expanded="{{ request()->is('eris-report*') ? 'true' : 'false' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="h-6 w-6 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900">
                            <path
                                d="M5.625 1.5c-1.036 0-1.875.84-1.875 1.875v17.25c0 1.035.84 1.875 1.875 1.875h12.75c1.035 0 1.875-.84 1.875-1.875V12.75A3.75 3.75 0 0016.5 9h-1.875a1.875 1.875 0 01-1.875-1.875V5.25A3.75 3.75 0 009 1.5H5.625z" />
                ...
                <li>
                    <button type="button"
                        class="group flex w-full items-center rounded-lg p-2 text-gray-900 transition duration-75 hover:bg-gray-100"
                        aria-controls="competency-dropdown-reports" data-collapse-toggle="competency-dropdown-reports" aria-expanded="{{ request()->is('competency-report*') ? 'true' : 'false' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="h-6 w-6 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900">
                            <path
                                d="M5.625 1.5c-1.036 0-1.875.84-1.875 1.875v17.25c0 1.035.84 1.875 1.875 1.875h12.75c1.035 0 1.875-.84 1.875-1.875V12.75A3.75 3.75 0 0016.5 9h-1.875a1.875 1.875 0 01-1.875-1.875V5.25A3.75 3.75 0 009 1.5H5.625z" />
                    ...
                    <ul id="competency-dropdown-reports" class="{{ request()->is('competency-report*') ? '' : 'hidden' }} space-y-2 py-2">
                        <li>
                            <li>
                ...
                <li>
                    <button type="button"
                        class="group flex w-full items-center rounded-lg p-2 text-gray-900 transition duration-75 hover:bg-gray-100"
                        aria-controls="dropdown-plantilla-library" data-collapse-toggle="dropdown-plantilla-library" aria-expanded="{{ request()->is('plantilla/library*') ? 'true' : 'false' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="h-6 w-6 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900">
                            <path
                                d="M11.25 4.533A9.707 9.707 0 006 3a9.735 9.735 0 00-3.25.555.75.75 0 00-.5.707v14.25a.75.75 0 001 .707A8.237 8.237 0 016 18.75c1.995 0 3.823.707 5.25 1.886V4.533zM12.75 20.636A8.214 8.214 0 0118 18.75c.966 0 1.89.166 2.75.47a.75.75 0 001-.708V4.262a.75.75 0 00-.5-.707A9.735 9.735 0 0018 3a9.707 9.707 0 00-5.25 1.533v16.103z" />
                ...
                <li>
                    <button type="button"
                        class="group flex w-full items-center rounded-lg p-2 text-gray-900 transition duration-75 hover:bg-gray-100"
                        aria-controls="dropdown-plantilla-reports" data-collapse-toggle="dropdown-plantilla-reports" aria-expanded="{{ request()->is('plantilla/reports*') ? 'true' : 'false' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="h-6 w-6 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900">
                            <path
