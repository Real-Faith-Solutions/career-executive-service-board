            ...
            <li>
                ...
                <ul id="dropdown-dashboard" class="hidden space-y-2 py-2">
                    @if (Auth::user()->role == 'User')
                        <li>
                            <a href="{{ env('APP_URL') }}admin/profile/views/{{ Auth::user()->cesno }}" class="group flex w-full items-center rounded-lg p-2 text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View Profile</a>
                        </li>
                    @else
