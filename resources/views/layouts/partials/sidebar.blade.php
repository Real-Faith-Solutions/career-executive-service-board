                ...
                <ul id="dropdown-dashboard" class="hidden space-y-2 py-2">
                    ...
                    <li>
                        <a href="{{ route('profile.add') }}"
                            class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100">Add
                            Profile</a>
                    </li>
                    @endif
                    ...
                    <li>
                        <a href="{{ route('view-profile-201.index') }}"
                            class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100">View
                            Profile</a>
                    </li>
                ...
                <ul id="dropdown-system-utility" class="hidden space-y-2 py-2">
                    <li>
                        <a href="{{ route('gender-by-birth.index') }}"
                            class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100">Gender
                            bv birth</a>
                        <a href="{{ route('gender-by-choice.index') }}"
                            class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100">Gender
                            bv choice</a>
                        <a href="{{ route('civil-status.index') }}"
                            class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100">Civil
                            Status</a>
                        <a href="{{ route('title.index') }}"
                            class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100">Title</a>
                        <a href="{{ route('record-status.index') }}"
                            class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100">Record
                            Status</a>
                        <a href="{{ route('religion.index') }}"
                            class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100">Religion</a>
                        <a href="{{ route('indigeneous-group.index') }}"
                            class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100">Indigenous
                            Group</a>
                        <a href="{{ route('pwd.index') }}"
                            class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100">PWD
                            Disability</a>
                        {{-- <a href="{{ route('civil-status.index') }}"
                        ...
                        <a href="{{ route('educational-schools.index') }}"
                            class="group flex w-full items-center rounded-lg p-2 pl-11 text-gray-900 transition duration-75 hover:bg-gray-100">Educational
                            Schools</a>
