    ...
    <div class="col-xl-9 col-lg-12 col-md-12">
        ...
        <div class="card o-hidden border-0 shadow-lg my-2">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-login-image" style="background-image: url('{{ asset('assets/branding.png') }}'); background-size: 70% auto; background-repeat: no-repeat;background-color: #4e73df;"></div>
                    <div class="col-lg-7">
                        <div class="p-5 mx-5">
